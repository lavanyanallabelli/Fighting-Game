...
class Game {
  ...
  reset(p1,p2) {
    // set p1 health and p2 health back to 100 and 
    p1.health = 100
    p2.health = 100
    this.isOver = false
    //isOver back to false and clear resultDiv.innerText and don't forget to updateGame()
    resultDiv.innerText = ''
...
let jk = new Player('JK',100,7)
console.log(jk)
let lav = new Player('Lav',100,7)
console.log(lav.name)
console.log(lav.health)
console.log(lav.attackDmg)
...
document.addEventListener('keydown', function(e) {
  ...
  // if you press a AND the enemy health is greater than 0 AND isOver is still false then heal()
...
document.addEventListener('keydown', function(e) {
  ...
  // if you press p AND player health is greater than 0 AND isOver is still false then stike()
